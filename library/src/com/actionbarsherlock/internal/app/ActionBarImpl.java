...
public class ActionBarImpl extends ActionBar {
	...
	public void setHomeAsUpIndicator(Drawable drawable) {
		...
		if (home == null) {
			// Action bar doesn't have a known configuration, implementation was
		...
		if (childCount != 2) {
			// No idea which one will be the right one, implementation was
			// changed unexpectedly
			return;
		}
	...
	public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
		...
		public ActionModeImpl(ActionMode.Callback callback) {
			mCallback = callback;
			mMenu = new MenuBuilder(getThemedContext()).setDefaultShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
