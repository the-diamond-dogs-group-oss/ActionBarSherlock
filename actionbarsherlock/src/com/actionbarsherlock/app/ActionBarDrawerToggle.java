...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
	 ...
	 * 
	 * @param context
	 *            A valid context for loading resources
	 * @param actionBar
	 *            The ActionBar of the hosting Activity
	 * @param drawerLayout
	 ...
	 *            accessibility
	 */
	public ActionBarDrawerToggle(Activity activity, ActionBar actionBar, DrawerLayout drawerLayout, int drawerImageRes,
	...
	public void syncState() {
		...
		if (mDrawerIndicatorEnabled) {
			...
			mActionBar.setHomeActionContentDescription(mDrawerLayout.isDrawerOpen(GravityCompat.START) ? mOpenDrawerContentDescRes
